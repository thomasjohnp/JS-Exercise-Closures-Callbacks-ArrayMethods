...
function getRunnersByTShirtSize(runners, tShirtSize) {
  let shirts = runners.filter(function(runners) { return runners.shirt_size === tShirtSize;})
  return shirts;
}
...
function tallyUpDonations(runners) {
  let totalDonations = runners.reduce(function(additive, step) {
    return step.donation + additive;
  }, 0);
